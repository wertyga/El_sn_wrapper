...
import login from '../../../screenshots/1.png';
import power from '../../../screenshots/2.png';
import power1 from '../../../screenshots/3.png';
import settings from '../../../screenshots/4.png';
import main from '../../../screenshots/6.png';
import whales from '../../../screenshots/Screenshot_2.png';
            ...
            <div className="description">
                ...
                <div className="content">
                    <div>
                        ...
                        {/*</p>*/}
                        <div className="final"><span>Yours:</span>   © Wc.Technologies</div>
                    </div>
                </div>
            </div>
        );
        const screenshots = (
            <div className="screenshots">
                ...
                <div className="content">
                    ...
                    <div className="screen_wrapper">
                        <div className="img_wrapper" onClick={this.zoomImage}>
                            <img src={main} alt="settings_screen"/>
                        </div>
                        <div className="desc">
